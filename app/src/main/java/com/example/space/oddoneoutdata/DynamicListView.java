...
public class DynamicListView extends ListView  {
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            observer.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { public boolean onPreDraw() { observer.removeOnPreDrawListener(this); View mobileView = getViewForID(mMobileItemId);
    ...
    private void swapElements(ArrayList arrayList, int indexOne, int indexTwo) {
        ...
        swapSceneArray(sceneData,indexOne,indexTwo);
    ...
    public void setSceneData(ArrayList<ArrayList<Map<String, String>>> scenedata){
        sceneData = scenedata;
    }
    ...
    public void swapSceneArray(ArrayList arrayList, int indexOne, int indexTwo){
